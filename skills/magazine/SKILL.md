...
| Short paragraph introducing a mermaid fence | The plate's lead-in, in its own place, inside the plate's frame |
| A figure's title (one bold line just above the fence) and caption (one italic line just below) — the diagram skill requires both | The title under the figure number, the caption beneath the plate, both inside its frame and true black; never printed again as paragraphs |
